...
- To run the script that starts the simulation, open MATLAB and navigate to the project folder. Then, type `helperAMPCSetUp` in the command window and press Enter.
